      ...
      <div className="pt-24 pb-16">
        <div className="container mx-auto px-4">
          ...
          <div className="text-center mb-12">
            ...
            <h1 className="font-heading text-3xl md:text-5xl font-bold gold-text mb-4">Function Hall</h1>
            <div className="w-24 h-0.5 gold-gradient mx-auto" />
          </div>

          <div className="grid md:grid-cols-2 gap-8 mb-12">
            <div className="overflow-hidden rounded-2xl gold-border-glow">
              <img src={hallInterior} alt="Function hall interior" className="w-full h-72 md:h-96 object-cover hover:scale-105 transition-transform duration-700" />
            </div>
            <div className="overflow-hidden rounded-2xl gold-border-glow">
              <img src={hallSeating} alt="Function hall seating" className="w-full h-72 md:h-96 object-cover hover:scale-105 transition-transform duration-700" />
            </div>
          </div>
