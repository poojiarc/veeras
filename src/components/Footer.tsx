        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-foreground/70">
              {["Weddings & Receptions", "Engagements", "Birthday Parties", "Anniversaries", "Naming Ceremonies", "Corporate Meetings"].map((s) => (
          ...
          {/* Contact */}
          <div>
            <h4 className="font-heading text-lg font-semibold text-primary mb-4">Contact Info</h4>
            <ul className="space-y-3 text-sm text-foreground/70">
              <li className="flex items-start gap-2">
                <Phone className="w-4 h-4 text-primary mt-0.5" />
                <span>9908946726, 9006515510, 9652522691</span>
              </li>
              <li className="flex items-start gap-2">
                <Mail className="w-4 h-4 text-primary mt-0.5" />
                <span>veerachandramma25@gmail.com</span>
              </li>
              <li className="flex items-start gap-2">
                <MapPin className="w-4 h-4 text-primary mt-0.5" />
                <span>Near Sri Mahanandeswara Swamy Temple</span>
              </li>
            </ul>
            <div className="flex gap-3 mt-4">
              <a href="https://www.instagram.com/vcfunctionhall" target="_blank" rel="noopener noreferrer" className="p-2 glass-card rounded-lg hover:bg-primary/10 transition-colors">
              ...
              <a href="https://www.facebook.com/vcfunctionhall" target="_blank" rel="noopener noreferrer" className="p-2 glass-card rounded-lg hover:bg-primary/10 transition-colors">
                <svg className="w-4 h-4 text-primary" fill="currentColor" viewBox="0 0 24 24">
