      ...
      <div className="glass-card rounded-2xl p-8 space-y-6">
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <a href="tel:9006515510" className="block text-foreground/75 hover:text-primary transition-colors">9006515510</a>
...
const MapEmbed = () => {
  const { ref, isVisible } = useScrollAnimation();
  return (
    <div ref={ref} className={`mt-16 transition-all duration-700 ${isVisible ? "animate-fade-in-up" : "opacity-0"}`}>
      <div className="overflow-hidden rounded-2xl gold-border-glow">
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3825.!2d80.!3d16.!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2sVeera+Chandramma+Function+Hall!5e0!3m2!1sen!2sin!4v1"
          width="100%"
          height="400"
          style={{ border: 0 }}
          allowFullScreen
